...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = '¡Sabia que aceptarias MUAAA TE AMO MI PEQUEÑA... Hey tienes mi corazon en tus manos MUAA!!! ❤️❤️❤️';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 2:
            ...
            document.getElementById('noBtn').innerHTML = 'Di que siiii';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 13:
            ...
            document.getElementById('noBtn').innerHTML = 'Estás rompiendo mi corazón en pedacitos :(';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 14:
            ...
            document.getElementById('noBtn').innerHTML = 'NO... ya di que si anda no seas mala';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 16:
                document.getElementById('noBtn').innerHTML = 'Sii por favooooooor';
                document.getElementById('noBtn').style.backgroundColor = '#F1330A';
